% This is the cenTeX version of the plain TeX format that's described in
...
% reserved for \output; \count255, \dimen255, and \skip255 can be used 
freely.

% It is recommended that macro designers always use
% \global assignments with respect to registers numbered 1, 3, 5, 7, 9, and
% always non-\global assignments with respect to registers 0, 2, 4, 6, 8, 
255.
...
% CHANGE: 
% CENTEX font definitions are taken from the file FONT_SIZES.TEX
...
%
%\font\preloaded=manfnt % METAFONT logo and dragon curve and special 
symbols
%
...
\def\raggedright{\rightskip\z@ plus2em \spaceskip.3333em 
...
% CHANGE: 
% The following command is moved to the CENTEX file FONT_SIZES.TEX
% after the \tenex font is defined
...
% CHANGE: 
% magnification is not used in CENTEX
...
% CHANGE: 
% Defer these commands to the CENTEX file INITIALIZE.TEX
